...
class AttributeSeeder extends Seeder
{
    ...
    public function run($parameters = [])
    {
        ...
        DB::table('attributes')->insert([
            ...
            [
                'code' => 'title',
                'name' => trans('installer::app.seeders.attributes.tasks.title', [], $defaultLocale),
                'type' => 'text',
                'entity_type' => 'tasks',
                'lookup_type' => null,
                'validation' => null,
                ...
                'code' => 'description',
                'name' => trans('installer::app.seeders.attributes.tasks.description', [], $defaultLocale),
                'type' => 'textarea',
                'entity_type' => 'tasks',
                'lookup_type' => null,
                'validation' => null,
                ...
                'code' => 'status',
                'name' => trans('installer::app.seeders.attributes.tasks.status', [], $defaultLocale),
                'type' => 'select',
                'entity_type' => 'tasks',
                'lookup_type' => null,
                'validation' => null,
                ...
                'code' => 'priority',
                'name' => trans('installer::app.seeders.attributes.tasks.priority', [], $defaultLocale),
                'type' => 'select',
                'entity_type' => 'tasks',
                'lookup_type' => null,
                'validation' => null,
                ...
                'code' => 'deadline',
                'name' => trans('installer::app.seeders.attributes.tasks.deadline', [], $defaultLocale),
                'type' => 'date',
                'entity_type' => 'tasks',
                'lookup_type' => null,
                'validation' => null,
                ...
                'code' => 'created_by',
                'name' => trans('installer::app.seeders.attributes.tasks.created_by', [], $defaultLocale),
                'type' => 'lookup',
                'entity_type' => 'tasks',
                'lookup_type' => 'users',
                'validation' => null,
                ...
                'code' => 'assigned_to',
                'name' => trans('installer::app.seeders.attributes.tasks.assigned_to', [], $defaultLocale),
                'type' => 'lookup',
                'entity_type' => 'tasks',
                'lookup_type' => 'users',
                'validation' => null,
                ...
                'code' => 'group_id',
                'name' => trans('installer::app.seeders.attributes.tasks.group', [], $defaultLocale),
                'type' => 'lookup',
                'entity_type' => 'tasks',
