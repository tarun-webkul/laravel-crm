...
use Webkul\TaskManager\DataGrids\TaskGroupMembersDatagrid;
...
class TaskGroupUserController extends Controller
{
    ...
    public function index(int $taskGroupId)
    {
        ...
        return view(
            'taskmanager::task_groups.manage_members.index',
    ...
    public function assign(AttributeForm $request, int $taskGroupId): JsonResponse
    {
        try {
            ...
            return response()->json([
                'message' => trans('taskmanager::app.task_manager.task_groups.manage-members.assign-success'),
            ]);
        } catch (Exception $e) {
            return response()->json([
                'message' => trans('taskmanager::app.task_manager.task_groups.manage-members.assign-failed'),
            ], 500);
        }
    }
    ...
    public function unassign(int $taskGroupId, int $userId): JsonResponse
    {
        try {
            ...
            return response()->json([
                'message' => trans('taskmanager::app.task_manager.task_groups.manage-members.unassign-success'),
            ]);
        } catch (Exception $e) {
            return response()->json([
                'message' => trans('taskmanager::app.task_manager.task_groups.manage-members.unassign-failed'),
            ], 500);
        }
    }
