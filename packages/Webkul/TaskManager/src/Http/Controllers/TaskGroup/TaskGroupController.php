...
namespace Webkul\TaskManager\Http\Controllers\TaskGroup;
...
use Webkul\TaskManager\DataGrids\TaskGroupDataGrid;
...
class TaskGroupController extends Controller
{
    ...
    public function index(): View|JsonResponse
    {
        ...
        return view('taskmanager::task_groups.index');
    }
    ...
    {
        return view('taskmanager::task_groups.create');
    }
    ...
    public function store(AttributeForm $request): RedirectResponse|JsonResponse
    {
        ...
        if (request()->ajax()) {
            return response()->json([
                'data' => $taskGroup,
                'message' => trans('taskmanager::app.task_manager.task_groups.index.create-success'),
            ]);
        }

        session()->flash('success', trans('taskmanager::app.task_manager.task_groups.index.create-success'));
    ...
    public function edit(int $id): View
    {
        ...
        return view('taskmanager::task_groups.edit', compact('taskGroup'));
    }
    ...
    public function update(AttributeForm $request, int $id): RedirectResponse
    {
        ...
        session()->flash('success', trans('taskmanager::app.task_manager.task_groups.index.update-success'));
    ...
    public function destroy(int $id): JsonResponse
    {
        try {
            ...
            return response()->json([
                'message' => trans('taskmanager::app.task_manager.task_groups.index.delete-success'),
            ], 200);
        } catch (\Exception $exception) {
            return response()->json([
                'message' => trans('taskmanager::app.task_manager.task_groups.index.delete-failed'),
            ], 400);
        }
    }
