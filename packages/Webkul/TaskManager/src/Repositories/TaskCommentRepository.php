...
class TaskCommentRepository extends Repository
{
    ...
    public function create(array $data)
    {
        ...
        if (
            ...
            abort(403, trans('taskmanager::app.task_manager.task_comments.index.internal_notes_restricted'));
        }
        ...
        if (! $canComment) {
            abort(403, trans('taskmanager::app.task_manager.task_comments.index.comment_access_denied'));
        }
