<x-admin::layouts>
    <!-- Page Title -->
    <x-slot:title>
        @lang('taskmanager::app.task_manager.task_groups.manage-members.title', [
            'name' => $taskGroup->name
        ])
    </x-slot>
        ...
        <div class="scroll-reactive-sticky sticky top-[60px] z-[1000] flex items-center justify-between rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm shadow-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            ...
            <div class="flex items-center gap-x-2.5">
                ...
                @if (bouncer()->hasPermission('task_manager.task_groups.manage-members.assign'))
                    ...
                    >
                        @lang('taskmanager::app.task_manager.task_groups.manage-members.assign-btn')
                    </button>
                @endif
                    ...
                    assignUser() {
                        ...
                        if (!this.selectedUserId) {
                            this.$emitter.emit('add-flash', {
                                type: 'error',
                                message: "{{ trans('taskmanager::app.task_manager.task_groups.manage-members.select-user') }}"
                            });
                            return;
                        }
